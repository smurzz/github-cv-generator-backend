...
public class Repo {
	 ...
	 * @param homepage
	 */
	public Repo(Integer id, String nodeId, String name, String fullName, Boolean _private, Owner owner, String htmlUrl,
			...
			Boolean hasProjects, Boolean hasDownloads, Boolean hasWiki, Boolean hasPages, Boolean hasDiscussions,
			Integer forksCount, Object mirrorUrl, Boolean archived, Boolean disabled, Integer openIssuesCount,
			Object license, Boolean allowForking, Boolean isTemplate, Boolean webCommitSignoffRequired,
			List<Object> topics, String visibility, Integer forks, Integer openIssues, Integer watchers,
